...
class Settings(BaseSettings):
    ...
    # Set to 0 to disable.
    task_completion_max_reminders: int = Field(2, alias="ROBGJC_TASK_COMPLETION_MAX_REMINDERS")
    gjc_command: str = Field("gjc", alias="ROBGJC_GJC_COMMAND")
    ...
    # complete cleanly; any still running after that get their gjc
